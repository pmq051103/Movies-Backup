...
export default function TvShowProgramPage() {
  ...
  const { data, isLoading, isError } = useTvShowPrograms(apiParams);
  ...
  return (
    <>
      <Helmet>
        <title>{t('seo.tvShowProgramTitle')}</title>
        <meta name="description" content="TV Show, gameshow, truyền hình thực tế mới nhất, xem online miễn phí tại Không Gian Phim. Vietsub, Thuyết minh, Lồng tiếng." />
        <meta property="og:title" content={t('seo.tvShowProgramTitle')} />
        <meta property="og:description" content="TV Show, gameshow, truyền hình thực tế mới nhất, xem online miễn phí." />
        <meta property="og:url" content={`https://khonggianphim.online${ROUTES.TV_SHOW_PROGRAMS}`} />
        <link rel="canonical" href={`https://khonggianphim.online${ROUTES.TV_SHOW_PROGRAMS}`} />
      </Helmet>
